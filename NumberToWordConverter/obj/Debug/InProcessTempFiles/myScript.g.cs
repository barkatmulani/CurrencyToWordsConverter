...
namespace NumberToWordConverter.Scripts {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class myScript : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(myScript).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(myScript));
        ...
        private string FindResource() {
            string[] resources = typeof(myScript).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".myScript.g.xaml") || resource.Equals("myScript.g.xaml"))) {
                    return resource;
                }
            }
